...
use gpui::{
    actions, black, div, fill, hsla, point, prelude::*, px, relative, rgb, rgba, size, white, App,
...
impl TextInput {
    ...
    pub fn new_submit(cx: &mut Context<Self>, placeholder: impl Into<SharedString>) -> Self {
